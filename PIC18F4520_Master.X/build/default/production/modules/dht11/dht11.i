...
# 10 "modules/dht11/dht11.c" 2
 ...
 int8_t dht_read11(uint8_t pin)
 {
  int8_t result = dht_readSensor(pin, 18, 1);
  bits[0] &= 0x7F;
  bits[2] &= 0x7F;
