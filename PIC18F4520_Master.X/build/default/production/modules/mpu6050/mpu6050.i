...
# 2 "<built-in>" 2
# 1 "modules/mpu6050/mpu6050.c" 2
# 1 "lib/system/system.h" 1
# 15 "lib/system/system.h"
...
# 16 "lib/system/system.h" 2
# 1 "lib/delay/delay.h" 1
# 15 "lib/delay/delay.h"
void delay_ms(unsigned int d);
void delay_us(unsigned int d);
# 17 "lib/system/system.h" 2
...
# 2 "modules/mpu6050/mpu6050.c" 2
# 1 "modules/mpu6050/mpu6050.h" 1
# 17 "modules/mpu6050/mpu6050.h"
void mpu6050_init(void);
void mpu6050_read(int16_t *);
# 3 "modules/mpu6050/mpu6050.c" 2
# 1 "lib/i2c/i2c.h" 1
# 15 "lib/i2c/i2c.h"
void i2c_init(void);
void i2c_start(void);
...
# 4 "modules/mpu6050/mpu6050.c" 2
void mpu6050_init()
{
    i2c_init();
    i2c_device_write(0xD0,0x6B,0);
}

void mpu6050_read(int16_t *str)
{
    str[0]=(i2c_device_read(0xD0,0x3B)<<8)|(i2c_device_read(0xD0,0x3C));
    str[1]=(i2c_device_read(0xD0,0x3D)<<8)|(i2c_device_read(0xD0,0x3E));
    str[2]=(i2c_device_read(0xD0,0x3F)<<8)|(i2c_device_read(0xD0,0x40));

    str[3]=(i2c_device_read(0xD0,0x41)<<8)|(i2c_device_read(0xD0,0x42));

    str[4]=(i2c_device_read(0xD0,0x43)<<8)|(i2c_device_read(0xD0,0x44));
    str[5]=(i2c_device_read(0xD0,0x45)<<8)|(i2c_device_read(0xD0,0x46));
    str[6]=(i2c_device_read(0xD0,0x47)<<8)|(i2c_device_read(0xD0,0x48));
