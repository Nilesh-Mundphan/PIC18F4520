...
# 6 "demo.c" 2
# 1 "lib/eeprom/eeprom.h" 1
# 14 "lib/eeprom/eeprom.h"
...
# 7 "demo.c" 2
# 1 "lib/systick/systick.h" 1
# 15 "lib/systick/systick.h"
void systick_init(void);
volatile unsigned char timer_count=0;
volatile unsigned int system_tick=0;
void sys_interrupt(void);
# 8 "demo.c" 2
# 1 "modules/mcp320x/mcp320x.h" 1
# 15 "modules/mcp320x/mcp320x.h"
uint16_t read_mcp320x(uint8_t channel);
# 9 "demo.c" 2
# 1 "modules/rtc/time.h" 1
# 15 "modules/rtc/time.h"
...
# 12 "demo.c" 2
# 1 "modules/dht11/dht11.h" 1
# 13 "modules/dht11/dht11.h"
# 1 "lib/gpio/gpio.h" 1
# 15 "lib/gpio/gpio.h"
...
# 14 "modules/dht11/dht11.h" 2
# 54 "modules/dht11/dht11.h"
...
# 13 "demo.c" 2
# 1 "modules/hcsr04/hcsr04.h" 1
# 21 "modules/hcsr04/hcsr04.h"
